...
/*   Updated: 2022/04/02 22:58:58 by jbrown           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*	As each bit is recieved from the client, the information is built up bit by
	bit until we have a full byte. The first 4 bytes recieved will contain the
	...
	has been made it is immediately printed. Finally, an empty byte is recieved
	...
	server can recieve another message.	*/
